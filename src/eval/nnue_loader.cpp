...
bool NNUELoader::load_from_memory(const uint8_t* data, size_t size, NNUEWeights& weights) {
...
bool NNUELoader::read_feature_transformer(std::istream& stream, NNUEWeights& weights) {
...
bool NNUELoader::read_network(std::istream& stream, NNUEWeights& weights) {
    ...
    for (int stack = 0; stack < LAYER_STACKS; ++stack) {
        ...
        stream.read(reinterpret_cast<char*>(&weights.fc0_weights[fc0_weight_offset]),
        ...
        stream.read(reinterpret_cast<char*>(&weights.fc1_weights[fc1_weight_offset]),
        ...
        stream.read(reinterpret_cast<char*>(&weights.fc2_weights[fc2_weight_offset]),
