...
template <IndexType L1, int L2, int L3> struct NetworkArchitecture {
  ...
  std::int32_t
  propagate(const TransformedFeatureType *transformedFeatures) const {
...
template <MetalFish::Eval::NNUE::IndexType L1, int L2, int L3>
struct std::hash<MetalFish::Eval::NNUE::NetworkArchitecture<L1, L2, L3>> {
  std::size_t
  operator()(const MetalFish::Eval::NNUE::NetworkArchitecture<L1, L2, L3> &arch)
      const noexcept {
