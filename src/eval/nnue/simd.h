...
namespace MetalFish::Eval::NNUE::SIMD {
...
using vec_t = __m128i;
using vec_i8_t =
    std::uint64_t; // for the correct size -- will be loaded into an xmm reg
using vec128_t = __m128i;
...
inline int8x16_t vmovl_high_s8(int8x16_t val) {
  return vmovl_s8(vget_high_s8(val));
}
#endif
