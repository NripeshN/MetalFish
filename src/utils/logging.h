...
#define LOGFILE ::MetalFish::LogMessage(__FILE__, __LINE__)
#define CERR ::MetalFish::StderrLogMessage(__FILE__, __LINE__)
#define COUT ::MetalFish::StdoutLogMessage(__FILE__, __LINE__)
