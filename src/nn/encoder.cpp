...
bool IsCanonicalFormat(pbMetalFish::NN::NetworkFormat::InputFormat input_format) {
  return input_format >=
         pbMetalFish::NN::NetworkFormat::INPUT_112_WITH_CANONICALIZATION;
}
...
bool IsHectopliesFormat(pbMetalFish::NN::NetworkFormat::InputFormat input_format) {
  return input_format >=
         pbMetalFish::NN::NetworkFormat::INPUT_112_WITH_CANONICALIZATION_HECTOPLIES;
}
bool Is960CastlingFormat(pbMetalFish::NN::NetworkFormat::InputFormat input_format) {
  return input_format >= pbMetalFish::NN::NetworkFormat::INPUT_112_WITH_CASTLING_PLANE;
}
...
InputPlanes EncodePositionForNN(
  ...
  ChessBoard::Castlings castlings;
  {
    ...
    switch (input_format) {
      case pbMetalFish::NN::NetworkFormat::INPUT_CLASSICAL_112_PLANE: {
      ...
      case pbMetalFish::NN::NetworkFormat::INPUT_112_WITH_CASTLING_PLANE:
      case pbMetalFish::NN::NetworkFormat::INPUT_112_WITH_CANONICALIZATION:
      case pbMetalFish::NN::NetworkFormat::INPUT_112_WITH_CANONICALIZATION_HECTOPLIES:
      case pbMetalFish::NN::NetworkFormat::
          INPUT_112_WITH_CANONICALIZATION_HECTOPLIES_ARMAGEDDON:
      case pbMetalFish::NN::NetworkFormat::INPUT_112_WITH_CANONICALIZATION_V2:
      case pbMetalFish::NN::NetworkFormat::
          INPUT_112_WITH_CANONICALIZATION_V2_ARMAGEDDON: {
  ...
  bool skip_non_repeats =
      input_format ==
          pbMetalFish::NN::NetworkFormat::INPUT_112_WITH_CANONICALIZATION_V2 ||
      input_format == pbMetalFish::NN::NetworkFormat::
                          INPUT_112_WITH_CANONICALIZATION_V2_ARMAGEDDON;
  bool flip = false;
