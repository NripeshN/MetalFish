...
{
    _inputTensor = [self placeholderWithShape:@[@(_maxBatchSize), @(channels), @1]
...
-(nonnull MPSGraphTensor *) maskPlaceholderWithInputChannels:(NSUInteger)channels
                                                       label:(NSString * __nullable)label
{
    _maskTensor = [self placeholderWithShape:@[@(_maxBatchSize), @(channels), @1]
                                    dataType:MPSDataTypeUInt64
                                        name:label];
    return _maskTensor;
}
...
-(nonnull MPSGraphTensor *) addEncoderLayerWithParent:(MPSGraphTensor * __nonnull)parent
                                        legacyWeights:(MetalFish::NN::MultiHeadWeights::EncoderLayer &)encoder
