...
private:
    ...
    bool allocate_network_buffers(GPUNetworkWeights& weights, int hidden_dim, bool has_threats);
};
...
private:
    ...
    bool dispatch_evaluation(const GPUNetworkWeights& weights, GPUEvalResults& results);
};
