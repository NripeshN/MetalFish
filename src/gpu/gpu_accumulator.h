/*
  ...
  This module provides GPU-accelerated accumulator management for NNUE evaluation.
  It mirrors the CPU AccumulatorStack but uses GPU memory and compute for:
...
public:
    ...
    bool extract(const Position& pos,
