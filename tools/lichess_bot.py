...
HYBRID_MCTS_AB_ROOT_HINTS = env_bool_string(
...
HYBRID_MCTS_AB_ROOT_HINT_COUNT = max(
    1, min(16, env_int("METALFISH_HYBRID_MCTS_AB_ROOT_HINT_COUNT", 4))
)
...
TRANSFORMER_MIN_MOVE_BUDGET_MS = max(
    0, min(5000, env_int("METALFISH_TRANSFORMER_MIN_MOVE_BUDGET_MS", 800))
)
BOOK_MAX_PLY = 10
