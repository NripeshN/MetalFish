...
HYBRID_MCTS_SHARED_TT = env_bool_string("METALFISH_HYBRID_MCTS_SHARED_TT", True)
...
GAME_STREAM_ACTIVE_RETRIES = max(8, env_int("METALFISH_GAME_STREAM_ACTIVE_RETRIES", 24))
