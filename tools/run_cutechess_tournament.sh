...
HYBRID_AB_CANDIDATE_VERIFY_MS="${HYBRID_AB_CANDIDATE_VERIFY_MS:-120}"
HYBRID_AB_CANDIDATE_VERIFY_COUNT="${HYBRID_AB_CANDIDATE_VERIFY_COUNT:-4}"
...
MCTS=(proto=uci restart="$ENGINE_RESTART" cmd="$MF" name=MetalFish-MCTS
      ...
      option.PureMCTSSmartPruningFactor=1.33
