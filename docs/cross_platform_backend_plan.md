...
| --- | --- | --- |
| Linux CPU build/test | `cloudbuild/linux-cpu.yaml` | `da6f4c8a-9d78-4cdc-8958-fe47ceeb4d63` |
| CUDA entrypoint compile/test | `cloudbuild/cuda-entrypoint.yaml` | `4cb94fb0-1b5d-434c-b54b-29ec8b7dd18e` |
