...
| CUDA GPU runtime gate | `tools/run_gcp_cuda_gpu_gate.sh` | `3d215b47`, `metalfish-cuda-runtime-20260526-130624`, L4, 2026-05-26; validates CUDA graph-replay MCTS warmup and packaged Linux CUDA smoke |
