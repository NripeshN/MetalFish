...
The 2026-05-26 direct GCP pass `direct-f18ac26` verified the
packaged runtime path on a Windows Server 2022 `g2-standard-4` L4 VM in
`us-east1-b`: the
