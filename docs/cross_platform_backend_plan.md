...
| --- | --- | --- |
| Linux CPU build/test | `cloudbuild/linux-cpu.yaml` | `7c0ed1bc-c0cd-4f9a-aa78-e0ce79199559` |
| CUDA entrypoint compile/test | `cloudbuild/cuda-entrypoint.yaml` | `e754aafb-ea8a-49eb-991c-e8ff68b0f4db` |
