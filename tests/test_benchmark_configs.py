...
def main() -> int:
    ...
    assert_file_contains(
        ...
        [
            ...
            "Validate Metal artifact provenance",
            "gh run view",
            "MetalFish CI",
            "METALFISH_EXPECTED_SHA",
            "workflowName",
            "status",
            "headSha",
            "conclusion",
    ...
    assert_file_contains(
        ...
        [
            ...
            "require_metal_compare",
            "stable_batch_size",
            "Validate Windows CUDA package provenance",
            "Validate Metal comparison inputs",
            "Validate Metal artifact provenance",
            "gh run view",
    ...
    assert_file_contains(
        ...
        [
            ...
            "METALFISH_WINDOWS_CUDA_BK07_POST_GO_SLEEP_MS:-30000",
            ...
            "cuda-bk07-mcts",
            "bestmove h5f6",
            "-GoWaitMs ${BK07_POST_GO_SLEEP_MS}",
            "cuda_bk07_mcts",
            "expected_bestmove",
            "--isolation-weights",
            "--full-policy",
