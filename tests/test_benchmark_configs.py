...
def main() -> int:
    ...
    assert_file_contains(
        ...
        [
            ...
            "Hybrid MCTS runtime",
            "resolve_nn_backend",
            "auto_mcts_can_scale_workers",
            "auto_hybrid_mcts_threads",
    ...
    assert_file_contains(
        ...
        [
            ...
            "python3 tests/test_uci_search_result_tools.py",
            ...
            "--json-out build/metal-mcts-kiwipete-search.json",
            "--json-out build/metal-mcts-after-e4-search.json",
            "--json-out build/metal-mcts-promotion-search.json",
            "--json-out build/metal-mcts-en-passant-search.json",
            "--json-out build/metal-hybrid-bk07-search.json",
            "--json-out build/metal-hybrid-kiwipete-search.json",
            "--json-out build/metal-hybrid-after-e4-search.json",
            "--json-out build/metal-hybrid-promotion-search.json",
            "--json-out build/metal-hybrid-en-passant-search.json",
    ...
    assert_file_contains(
        ...
        [
            ...
            "tools/cuda_runtime_manifest_writer.py",
            "tools/cuda_runtime_search_contract.py",
            "tools/compare_nn_backend_outputs.py",
            "tools/compare_uci_search_results.py",
            "tools/dispatch_cuda_release_artifacts.py",
            "tools/dispatch_cuda_runtime_gates.py",
    ...
    assert_file_contains(
        ...
        [
            ...
            "Hybrid regression attempt ${attempt}/2",
            "retrying once to filter benchmark variance",
            "report-attempt-${attempt}.json",
            "puzzle_count",
            "puzzle_movetime",
    ...
    assert_file_contains(
        ...
        [
            ...
            "profile_limit",
            "mcts_ponder_go",
            "mcts_ponder_settle_sec",
            "METALFISH_CUDA_MCTS_PONDER_GO",
            "METALFISH_CUDA_MCTS_PONDER_SETTLE_SEC",
            "METALFISH_CUDA_GRAPH_EXECUTION",
            "METALFISH_CUDA_PROFILE_LIMIT",
    ...
    assert_file_contains(
        PROJ / "tools/cuda_runtime_search_contract.py",
        [
            ...
            "Metal MCTS promotion search JSON",
            "Metal MCTS en-passant search JSON",
            "Metal Hybrid BK.07 search JSON",
            "Metal Hybrid kiwipete search JSON",
            "Metal Hybrid after-e4 search JSON",
            "Metal Hybrid promotion search JSON",
            "Metal Hybrid en-passant search JSON",
            ...
            "metal-windows-cuda-mcts-en-passant-search-summary.json",
        ],
    )
    assert_file_contains(
        PROJ / "tools/cuda_runtime_manifest_writer.py",
        [
            "Write Linux and Windows CUDA runtime gate manifests",
            "metalfish.cuda_gpu_runtime_gate",
            "metalfish.windows_cuda_runtime_gate",
            "linux-cuda",
            "windows-cuda",
            "collect_observed_runtime_facts",
            "SEARCH_COMPARISONS",
            "spec.gate_env_var",
            "artifact_records",
            "metal_input_records",
    ...
    assert_file_contains(
        ...
        [
            ...
            "search_info",
            "final_metrics",
            "extract_last_search_info",
            "extract_final_metrics",
        ],
    )
    assert_file_contains(
        PROJ / "tools/compare_uci_search_results.py",
        [
    ...
    assert_file_contains(
        ...
        [
            ...
            "METALFISH_CUDA_MCTS_PONDER_SETTLE_SEC",
            "SOURCE_COMMIT",
            "METALFISH_SOURCE_COMMIT is required",
            "tools/uci_ponder_smoke.py",
            ...
            "METALFISH_CUDA_GRAPH_REPLAY_WARMUP",
    ...
    assert_file_contains(
        ...
        [
            ...
            "Copy-MsvcRuntimeDlls",
            "BuildTests=ON is required",
            "check_cuda_package_artifacts.py",
            "--expected-source-commit",
            "SourceCommit",
            "VCToolsRedistDir",
            "VCINSTALLDIR",
            ...
            "Packaged JSON manifest missing runtime DLL entry",
            "Packaged runtime DLLs",
            "Packaged MSVC runtime DLLs",
            "packaged_msvc_runtime_dll_count",
            "Artifact manifest",
    ...
    assert_file_contains(
        ...
        [
            ...
            "METALFISH_WINDOWS_CUDA_MCTS_PONDER_UCI_GO",
            "METALFISH_WINDOWS_CUDA_MCTS_PONDER_SETTLE_MS",
            "METALFISH_WINDOWS_CUDA_STABLE_EXECUTION_BATCH_SIZE",
            "METALFISH_CUDA_GRAPH_EXECUTION",
            "METALFISH_WINDOWS_CUDA_PROFILE",
            "METALFISH_WINDOWS_CUDA_PROFILE_LIMIT",
            "CUBLAS_WORKSPACE_CONFIG",
    ...
    assert_file_contains(
        ...
        [
            ...
            "SEARCH_COMPARISONS",
            "spec.metal_artifact",
            "spec.metal_input_label",
            "spec.metalfish_env_var",
            ...
            "runtime-gate-env.sh",
            "runtime-gate-inputs-manifest.json",
            "metalfish.windows_cuda_runtime_inputs",
            "def file_record",
    ...
    assert_file_contains(
        ...
        [
            ...
            "METALFISH_CUDA_GRAPH",
            "METALFISH_CUDA_GRAPH_EXECUTION",
            "METALFISH_WINDOWS_CUDA_PROFILE",
            "METALFISH_WINDOWS_CUDA_PROFILE_LIMIT",
            "METALFISH_WINDOWS_CUBLAS_WORKSPACE_CONFIG",
            "CUBLAS_WORKSPACE_CONFIG",
            "CUBLAS_WORKSPACE_CONFIG_VALUE",
            "METALFISH_WINDOWS_CUDA_STABLE_EXECUTION_BATCH_SIZE",
            "METALFISH_WINDOWS_CUDA_STABLE_EXECUTION_BATCH_SIZE must be a positive integer",
            "METALFISH_WINDOWS_CUDA_GRAPH_REPLAY_WARMUP",
            "METALFISH_WINDOWS_CUDA_GRAPH_REPLAY_WARMUP must be a positive integer",
            "--warmup ${CUDA_GRAPH_REPLAY_WARMUP}",
            "METALFISH_WINDOWS_CUDA_COMPILE_RUN_ID",
            "SOURCE_COMMIT",
            "METALFISH_SOURCE_COMMIT is required",
            ...
            "windows-cuda-runtime-gate-manifest.json",
            "cuda_runtime_manifest_writer.py",
            ...
            "GATE_HYBRID_PARITY_UCI_GO",
            "GATE_CUDA_GRAPH_EXECUTION",
            "GATE_CUDA_DETERMINISTIC_ATTENTION_SOFTMAX",
            "GATE_CUDA_FULL_BUFFER_CLEAR",
            ...
            "METALFISH_WINDOWS_CUDA_MCTS_TIMED_UCI_GO:-movetime 500",
            "METALFISH_WINDOWS_CUDA_MCTS_PONDER_UCI_GO",
            "METALFISH_WINDOWS_CUDA_MCTS_PONDER_SETTLE_MS",
            "Invoke-UciPonderSmoke",
            "cuda_deterministic_attention_softmax",
            "cuda_full_buffer_clear",
            "cublas_workspace_config",
            "METALFISH_WINDOWS_CUDA_HYBRID_UCI_GO:-nodes 8",
            "METALFISH_WINDOWS_CUDA_HYBRID_PARITY_UCI_GO:-nodes 50",
            "mcts_timed_uci_go",
            "mcts_ponder_uci_go",
            "cuda-ponder-mcts",
            "hybrid_parity_uci_go",
            "metalfish_nn_probe.exe",
            "test_nn_comparison.exe",
            "windows-cuda-package-manifest.json",
            "metalfish.portable_artifact",
            ...
            "cuda-after-e4-mcts",
            "cuda-promotion-mcts",
            "cuda-en-passant-mcts",
            "cuda_timed_mcts",
            "cuda_ponder_mcts",
            "hybrid-cuda-kiwipete",
            "hybrid-cuda-after-e4",
            ...
            "cuda_after_e4_mcts",
            "cuda_promotion_mcts",
            "cuda_en_passant_mcts",
            "hybrid_cuda_promotion",
            "hybrid_cuda_en_passant",
            "expected_bestmove",
            "--isolation-weights",
            "--full-policy",
            "1858",
            ...
            "\\$StdoutTask.Value.Wait([int]\\$remainingMs)",
            ...
            "Starting Multi-Threaded MCTS Search",
            'RejectedText @("Time safety:", "Falling back to Alpha-Beta")',
            "MCTS runtime: backend=accelerator",
            "MCTS runtime: backend=cuda",
            "Hybrid MCTS runtime: backend=accelerator",
            "Hybrid MCTS runtime: backend=cuda",
            ...
            "search_info = (Find-LastSearchInfo",
            "final_metrics = (Find-FinalMetrics",
            'foreach (\\$name in @("depth", "seldepth", "nodes", "nps"))',
            '\\$scoreMatch = [regex]::Match(\\$line, "\\bscore\\s+(\\S+)\\s+(-?\\d+)\\b")',
            '\\$pvMatch = [regex]::Match(\\$line, "\\bpv\\s+(.+)$")',
            "readyok after setoption",
            "cuda-bk07-mcts-search.json",
            "cuda-kiwipete-mcts-search.json",
            "cuda-after-e4-mcts-search.json",
            "cuda-promotion-mcts-search.json",
            "cuda-en-passant-mcts-search.json",
            "hybrid-cuda-search.json",
            "hybrid-cuda-kiwipete-search.json",
            "hybrid-cuda-after-e4-search.json",
            "hybrid-cuda-promotion-search.json",
            "hybrid-cuda-en-passant-search.json",
            "go searchmoves a7a8q nodes 50",
            "legacy_probe",
            "probe_suites",
            "cuda_auto_mcts",
            ...
            "metal-windows-cuda-mcts-bk07-search-summary.json",
            "metal-windows-cuda-mcts-kiwipete-search-summary.json",
            "metal-windows-cuda-mcts-after-e4-search-summary.json",
            "metal-windows-cuda-mcts-promotion-search-summary.json",
            "metal-windows-cuda-mcts-en-passant-search-summary.json",
            "metal-windows-cuda-hybrid-bk07-search-summary.json",
            "metal-windows-cuda-hybrid-kiwipete-search-summary.json",
            "metal-windows-cuda-hybrid-after-e4-search-summary.json",
            "metal-windows-cuda-hybrid-promotion-search-summary.json",
            "metal-windows-cuda-hybrid-en-passant-search-summary.json",
            "METALFISH_METAL_COMPARISON_LOG",
            "METALFISH_METAL_MCTS_AFTER_E4_SEARCH_JSON",
            "METALFISH_METAL_MCTS_PROMOTION_SEARCH_JSON",
            "METALFISH_METAL_MCTS_EN_PASSANT_SEARCH_JSON",
    ...
    assert_file_contains(
        ...
        [
            ...
            "GATE_CUDA_UCI_GO",
            "GATE_CUDA_MCTS_PONDER_GO",
            "GATE_CUDA_MCTS_PONDER_SETTLE_SEC",
            "GATE_CUDA_STABLE_BATCH_SIZE",
            "GATE_CUDA_GRAPH",
            "GATE_CUDA_GRAPH_EXECUTION",
            "GATE_CUDA_PROFILE",
            "GATE_CUDA_PROFILE_LIMIT",
            "GATE_CUBLAS_WORKSPACE_CONFIG",
            "Packaged CUDA MCTS search JSON not found",
            "upload_collected_artifacts",
