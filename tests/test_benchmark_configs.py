...
def main() -> int:
    ...
    assert_file_contains(
        ...
        [
            ...
            "tools/compare_nn_backend_benchmarks.py",
            "tools/compare_nn_backend_outputs.py",
            "tools/compare_uci_search_results.py",
            ...
            "--json-out build/metal-mcts-bk07-search.json",
            "--json-out build/metal-hybrid-startpos-search.json",
    ...
    assert_file_contains(
        PROJ / "tools/compare_nn_backend_benchmarks.py",
        [
            "Compare NN backend batch benchmark lines",
            "--expected-log",
            "--actual-log",
            "--require-graph-reuse",
    ...
    assert_file_contains(
        ...
        [
            ...
            "METALFISH_SOURCE_COMMIT",
            "METALFISH_SOURCE_BRANCH",
            "METALFISH_CUDA_STABLE_EXECUTION_BATCH_SIZE",
            "METALFISH_WINDOWS_CUDA_STABLE_EXECUTION_BATCH_SIZE",
    ...
    assert_file_contains(
        ...
        [
            ...
            "METALFISH_WINDOWS_CUDA_HYBRID_UCI_GO:-nodes 8",
            "metalfish_nn_probe.exe",
            "test_nn_comparison.exe",
            "windows-cuda-package-manifest.json",
            "metalfish.portable_artifact",
            ...
            "Read-SmokeText",
            "Write-SearchJson",
            "cuda-bk07-mcts-search.json",
            "hybrid-cuda-search.json",
            "legacy_probe",
            "probe_suites",
            "cuda_auto_mcts",
            ...
            "compare_nn_backend_benchmarks.py",
            "compare_uci_search_results.py",
            "--require-actual-graph-reuse",
            ...
            "metal-windows-cuda-nn-benchmark-summary.json",
            "metal-windows-cuda-nn-benchmark-compare.log",
            "metal-windows-cuda-mcts-bk07-search-summary.json",
            "metal-windows-cuda-hybrid-startpos-search-summary.json",
            "METALFISH_METAL_COMPARISON_LOG",
            "METALFISH_REQUIRE_METAL_BENCHMARK_COMPARE",
            "METALFISH_REQUIRE_METAL_SEARCH_COMPARE",
            "METALFISH_MAX_CUDA_METAL_EVAL_MS_RATIO",
            "BENCHMARK_COMPARE_STATUS",
            "BENCHMARK_COMPARE_STATUS_FOR_MANIFEST",
            "benchmark_compare_status",
            "SEARCH_COMPARE_STATUS",
            "SEARCH_COMPARE_STATUS_FOR_MANIFEST",
            "search_compare_status",
