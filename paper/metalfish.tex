...
\item \textbf{Dispatch overhead is the bottleneck}: 149~$\mu$s irreducible minimum makes GPU unsuitable for single-position alpha-beta but effective for batch-oriented MCTS.
